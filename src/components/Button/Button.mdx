...
<Playground>
	...
	<hr />
	<ButtonList>
		<Button color="facebook" iconOnly>
			<BrandFacebook />
		</Button>
		<Button color="twitter" iconOnly>
			<BrandTwitter />
		</Button>
		<Button color="google" iconOnly>
			<BrandGoogle />
		</Button>
		<Button color="youtube" iconOnly>
			<BrandYoutube />
		</Button>
		<Button color="vimeo" iconOnly>
			<BrandVimeo />
		</Button>
		<Button color="dribbble" iconOnly>
			<BrandDribbble />
		</Button>
		<Button color="github" iconOnly>
			<BrandGithub />
		</Button>
		<Button color="instagram" iconOnly>
			<BrandInstagram />
		</Button>
		<Button color="pinterest" iconOnly>
			<BrandPinterest />
		</Button>
		<Button color="vk" iconOnly>
			<BrandVk />
		</Button>
		<Button color="rss" iconOnly>
			<Rss />
		</Button>
		<Button color="flickr" iconOnly>
			<BrandFlickr />
		</Button>
		<Button color="bitbucket" iconOnly>
			<BrandBitbucket />
		</Button>
		<Button color="tabler" iconOnly>
			<BrandTabler />
		</Button>
	</ButtonList>
</Playground>
