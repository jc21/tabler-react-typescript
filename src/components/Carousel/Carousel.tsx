...
export const Carousel: React.FC<CarouselProps> = ({
	...
	return (
	<div className={cn("carousel", "slide", className)} data-bs-ride="carousel">
		<ol className="carousel-indicators">
			<li data-bs-target="#carousel-sample" data-bs-slide-to="0" className="active"/>
		...
		<div className="carousel-inner">
			<div className="carousel-item active">
				<img className="d-block w-100" alt="" src="https://tabler-react-typescript.jc21.com/assets/9f36332564ca271d.jpg" />
			</div>
